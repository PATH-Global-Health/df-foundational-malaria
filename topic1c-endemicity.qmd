...
```{=html}
<iframe src="https://data.malariaatlas.org/trends?year=2022&metricGroup=Malaria&geographicLevel=pixel&metricSubcategory=Pf&metricType=rate&metricName=incidence" style="border:none; width:100%; height:600px;"></iframe>
```
